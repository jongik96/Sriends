      ...
      <div class="col-start-2 col-span-4 ">
        ...
        <p class="text-3xl font-bold flex justify-center">게시글 작성</p>
          <div class="grid grid-cols-6  mt-10">
              <div class="col-start-2 col-span-4 shadow-md border-solid border-2 bor    der-yellow-500 rounded-md ml-2">
                  <form @submit.prevent="submitForm">
                      ...
                      <div class="pt-5 pl-40">
                          ...
                          <input type="text"  class=" text-xl w-3/4 h-80  rounded-md border-2 border-yellow-400">
                      </div>
