...
public class ValidatorMessage {
    ...
    public static final String USER_PW_MESSAGE = "비밀번호는 숫자와 문자, 특수 문자를 포함해서 8자 이상 20자 이내로 입력해주세요.";
    ...
    public static final String USER_PHONE_MESSAGE = "숫자 11자리를 입력해주세요.";
    public static final String USER_NAME_MESSAGE = "유저 이름은 2 ~ 25자를 입력해주세요.";
